...
public class CustomExtensionMainClass implements BurpExtension, ExtensionUnloadingHandler {
    private CustomExtensionSharedParameters sharedParameters = null;
    ...
    public void initialize(MontoyaApi api) {
        ...
        this.sharedParameters = new CustomExtensionSharedParameters(
                "3.3",
                "Sharpener",
        ...
        try{
            ...
            if (sharedParameters.get_isUILoaded() || isDirty) {
                if (!BurpUITools.isMenuBarLoaded(sharedParameters.extensionName, sharedParameters.get_mainMenuBarUsingMontoya()) || isDirty) {
                    ...
                    sharedParameters.allSettings = new CustomExtensionGeneralSettings(sharedParameters);
