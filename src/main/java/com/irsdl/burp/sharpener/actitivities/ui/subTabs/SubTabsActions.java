...
*/
    ...
    private static JPopupMenu createPopupMenu(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler) {
        ...
        if (!currentSubTabsContainerHandler.isDotDotDotTab()) {
            ...
            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "High - Confirmed", "Arial", 18, true, false, false, "#f71414", "high"));
            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "High - Unconfirmed", "Arial", 18, true, false, false, "#f71414", "high-tbc"));

            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Medium - Confirmed", "Arial", 18, true, false, false, "#ff7e0d", "medium"));
            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Medium - Unconfirmed", "Arial", 18, true, false, false, "#ff7e0d", "medium-tbc"));

            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Low - Confirmed", "Arial", 16, true, false, false, "#FAD400", "low"));
            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Low - Unconfirmed", "Arial", 16, true, false, false, "#FAD400", "low-tbc"));

            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Info - Confirmed", "Arial", 16, true, true, false, "#0d9e1e", "info"));
            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Info - Unconfirmed", "Arial", 16, true, true, false, "#0d9e1e", "info-tbc"));

            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Interesting 1", "Arial", 16, true, true, false, "#395EEA", "interesting"));
            profileMenu.add(predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, "Interesting 2", "Arial", 16, true, true, false, "#D641CF", "interesting2"));

            profileMenu.add(predefiniedStyleMenuByIcon(sharedParameters, currentSubTabsContainerHandler, "False Positive", "false-positive"));
            profileMenu.add(predefiniedStyleMenuByIcon(sharedParameters, currentSubTabsContainerHandler, "Duplicate", "duplicate"));
            profileMenu.add(predefiniedStyleMenuByIcon(sharedParameters, currentSubTabsContainerHandler, "Tick", "tick"));
            profileMenu.add(predefiniedStyleMenuByIcon(sharedParameters, currentSubTabsContainerHandler, "Cross", "cross"));
        ...
        jumpToPreviouslySelectedTabMenu.addActionListener(e -> {
            jumpToPreviosulySelectedTab(sharedParameters, currentSubTabsContainerHandler, notificationMenuItem);
        });
        ...
        saveScreenshotToFileMenu.addActionListener(e -> {
            ...
            String saveLocation = UIHelper.showDirectorySaveDialog(sharedParameters.allSettings.subTabsSettings.lastSavedImageLocation, sharedParameters.get_mainFrame());
    ...
    private static JMenuItem predefiniedStyleMenuByIcon(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler, String text, String iconString) {
        return predefiniedStyleMenu(sharedParameters, currentSubTabsContainerHandler, text, currentSubTabsContainerHandler.getFontName(), (int) currentSubTabsContainerHandler.getFontSize(), currentSubTabsContainerHandler.isBold(), currentSubTabsContainerHandler.isItalic(), currentSubTabsContainerHandler.getVisibleCloseButton(), currentSubTabsContainerHandler.getColorCode(), iconString);
    }

    private static JMenuItem predefiniedStyleMenu(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler, String text, String fontName, int fontSize, boolean isBold, boolean isItalic, boolean isCloseButtonVisible, String colorCode, String iconString) {
        if (currentSubTabsContainerHandler == null)
            return null;
    ...
    public static boolean changeToolTabbedPaneUI_safe(SharpenerSharedParameters sharedParameters, BurpUITools.MainTabs currentToolTab, boolean shouldOriginalBeSet, int counter) {
        ...
        try {
            ...
            if (isOriginal || sharedParameters.isTabGroupSupportedByDefault) {
                ...
                sharedParameters.get_toolTabbedPane(currentToolTab).setUI(SubTabsCustomTabbedPaneUI.getUI(sharedParameters, currentToolTab));
            }
        ...
        if (sharedParameters.isFiltered(currentSubTabsContainerHandler.currentToolTab)) {
            ...
            if (sharedParameters.originalSubTabbedPaneUI.get(currentSubTabsContainerHandler.currentToolTab) == null)
                sharedParameters.originalSubTabbedPaneUI.put(currentSubTabsContainerHandler.currentToolTab,
                        sharedParameters.get_toolTabbedPane(currentSubTabsContainerHandler.currentToolTab).getUI());
    ...
    public static void toggleCurrentTabVisibility(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler) {
        ...
        sharedParameters.get_toolTabbedPane(currentSubTabsContainerHandler.currentToolTab).revalidate();
        sharedParameters.get_toolTabbedPane(currentSubTabsContainerHandler.currentToolTab).repaint();
        new java.util.Timer().schedule(
                new java.util.TimerTask() {
                    @Override
                    public void run() {
    ...
    public static void showPopupMenu(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler, AWTEvent event) {
        ...
        int x;
        int y;
        JTabbedPane tabbedPane = sharedParameters.get_toolTabbedPane(currentSubTabsContainerHandler.currentToolTab);
        if (tabbedPane.getTabLayoutPolicy() == JTabbedPane.SCROLL_TAB_LAYOUT && event instanceof MouseEvent) {
            x = ((MouseEvent) event).getX();
            y = ((MouseEvent) event).getY() + tabbedPane.getTabComponentAt(currentSubTabsContainerHandler.getTabIndex()).getHeight() / 2;
        } else {
            x = tabbedPane.getTabComponentAt(currentSubTabsContainerHandler.getTabIndex()).getX();
            y = tabbedPane.getTabComponentAt(currentSubTabsContainerHandler.getTabIndex()).getY() + tabbedPane.getTabComponentAt(currentSubTabsContainerHandler.getTabIndex()).getHeight();
        }
        // showing popup menu
    ...
    public static void jumpToPreviosulySelectedTab(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler, JMenuItem notificationMenuItem) {
        if (currentSubTabsContainerHandler == null)
            return;
    ...
    public static void renameTitle(SharpenerSharedParameters sharedParameters, SubTabsContainerHandler currentSubTabsContainerHandler) {
        ...
        String newTitle = UIHelper.showPlainInputMessage("Edit the Title", "Rename Title", currentSubTabsContainerHandler.getTabTitle(), sharedParameters.get_mainFrame());
