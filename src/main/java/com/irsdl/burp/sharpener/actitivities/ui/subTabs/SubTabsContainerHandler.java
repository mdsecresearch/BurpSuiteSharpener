...
public class SubTabsContainerHandler {
    ...
    public SubTabsContainerHandler(SharpenerSharedParameters sharedParameters, JTabbedPane tabbedPane, int tabIndex, boolean forComparison) {
        ...
        if (_parentTabbedPane instanceof JTabbedPane) {
            JTabbedPane currentParentTabbedPane = ((JTabbedPane) _parentTabbedPane);
            ...
            JTabbedPane currentParentTabbedPane = ((JTabbedPane) _parentTabbedPane.getParent());
            ...
            JPanel currentParentTabbedPane = ((JPanel) _parentTabbedPane);
    ...
    public String[] getTitleHistory() {
        if(titleHistory == null){
            titleHistory = new ArrayList<String>();
        }
    ...
    public boolean equals(Object o) {
        boolean result = false;
        if (isValid()) {
            if (o instanceof SubTabsContainerHandler) {
                SubTabsContainerHandler temp = (SubTabsContainerHandler) o;
